...
public final class ItemNewsBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView itemBookmark;
  ...
  private ItemNewsBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView itemBookmark,
      @NonNull ImageView itemImageView, @NonNull TextView itemTitle) {
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.itemBookmark;
      ImageView itemBookmark = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemNewsBinding((ConstraintLayout) rootView, itemBookmark, itemImageView,
          itemTitle);
    }
